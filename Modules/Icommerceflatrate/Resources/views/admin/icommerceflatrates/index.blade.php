...
<div class="col-xs-12 col-sm-9">
    ...
    <div class="col-xs-12">
        ...
        <div class="form-group ">
            <label for="cost">* {{trans('icommerceflatrate::icommerceflatrates.table.cost')}}</label>
            <input placeholder="{{trans('icommerceflatrate::icommerceflatrates.table.cost')}}" required="required" name="cost" type="number" step='0.01' min='0' id="cost" class="form-control" value="{{$method->options->cost}}">
        </div>
