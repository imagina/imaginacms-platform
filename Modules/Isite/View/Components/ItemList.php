...
class ItemList extends Component
{
    ...
    public function __construct($item,
                              ...
                              string $layout = 'item-list-layout-1',
                              $parentAttributes = null,
                              bool $withViewMoreButton = false,
                              string $viewMoreButtonLabel = 'isite::common.menu.viewMore',
                              bool $withCreatedDate = false,
                              $withUser = false,
                              string $formatCreatedDate = 'd \\d\\e M',
                              array $orderClasses = [],
                              bool $withCategory = false,
                              bool $withSummary = true,
                              int $numberCharactersSummary = 100,
                              $editLink = null,
                              $tooltipEditLink = null,
                              $itemComponentView = null,
                              string $itemComponentTarget = '_self',
                              $target = '_self',
                              $itemListLayout = null,
                              $positionNumber = null,
                              string $imageAspect = '1/1',
                              $imageAspectMobile = null,
                              string $imageObject = 'cover',
                              int $imageBorderRadio = 0,
                              $imageBorderRadioType = '1',
                              string $imageBorderStyle = 'solid',
                              int $imageBorderWidth = 0,
                              string $imageBorderColor = '#000000',
                              int $imagePadding = 0,
                              ...
                              bool $withTitle = true,
                              string $titleAlign = '',
                              string $titleTextSize = '20',
                              $titleTextSizeMobile = '20',
                              string $titleTextWeight = 'font-weight-bold',
                              string $titleTextTransform = '',
                              string $summaryAlign = 'text-left',
                              string $summaryTextSize = '16',
                              string $summaryTextWeight = 'font-weight-normal',
                              string $categoryAlign = 'text-left',
                              string $categoryTextSize = '18',
                              string $categoryTextWeight = 'font-weight-normal',
