...
namespace Modules\Icommercebraintree\Repositories\Eloquent;

use Illuminate\Support\Str;
use Modules\Core\Repositories\Eloquent\EloquentBaseRepository;
use Modules\Icommercebraintree\Repositories\IcommerceBraintreeRepository;

class EloquentIcommerceBraintreeRepository extends EloquentBaseRepository implements IcommerceBraintreeRepository
{
    /**
    ...
    public function update($model, $data)
    {
        ...
        if (($requestimage == null) || (! empty($requestimage))) {
            $requestimage = $this->saveImage($requestimage, 'assets/icommercebraintree/1.jpg');
        }
