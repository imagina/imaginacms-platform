    ...
    public function getItemsBy($params = false)
    {
        ...
        if (isset($params->filter)) {
            ...
            if (isset($filter->placeCategoryId) && $filter->placeCategoryId) {
                if (! is_array($filter->placeCategoryId)) {
                    $filter->placeCategoryId = [$filter->placeCategoryId];
                }
            ...
            if (isset($filter->placeCityId) && $filter->placeCityId) {
                if (! is_array($filter->placeCityId)) {
                    $filter->placeCityId = [$filter->placeCityId];
                }
                $query->whereHas('place', function ($query) use ($filter) {
            ...
            if (isset($filter->attendants) && $filter->attendants) {
                if (! is_array($filter->attendants)) {
                    $filter->attendants = [$filter->attendants];
                }
    ...
    public function updateBy($criteria, $data, $params = false)
    {
        ...
        if ($model) {
            ...
            if (isset($data['status'])) {
                ...
                } elseif ($data['status'] == Status::PUBLISHED) {
