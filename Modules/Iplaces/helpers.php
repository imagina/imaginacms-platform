...
if (! function_exists('get_places')) {
    function get_places($options = [])
    {
        $default_options = [

            'categories' => null,
            'users' => null, //usuario o usuarios que desea llamar
            'include' => [], //id de place a para incluir en una consulta
            'exclude' => [], // place, categorias o usuarios, que desee excluir de una consulta metodo de llmado tour=>'', places=>'' , users=>''
...
if (! function_exists('get_Iplaces_categories')) {
    function get_Iplaces_categories($options = [])
    {
        $default_options = [
