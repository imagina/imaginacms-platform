...
<div class="col-xs-12 col-sm-9">
    ...
    <div class="col-xs-12">
        ...
        <div class="form-group ">
            <label for="minimum">* {{trans('icommercefreeshipping::icommercefreeshippings.table.minimum')}}</label>
            <input placeholder="{{trans('icommercefreeshipping::icommercefreeshippings.table.minimum')}}" required="required" name="minimum" type="number" step='0.01' min='0' id="minimum" class="form-control" value="{{$method->options->minimum}}">
        </div>
