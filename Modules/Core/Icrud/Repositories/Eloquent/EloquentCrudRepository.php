...
abstract class EloquentCrudRepository extends EloquentBaseRepository implements BaseCrudRepository
{
    ...
    public function getOrCreateQuery($params, $criteria = null)
    {
        ...
        if (! empty($params)) {
            ...
            $newParams = (object) ['returnAsQuery' => true];
        }
        if (is_null($criteria)) {
    ...
    public function getItemsBy($params)
    {
        ...
        if (empty($this->query)) {
            ...
            if (isset($params->include)) {
                $query = $this->includeToQuery($query, $params->include);
            }
            ...
            if (isset($params->filter)) {
                ...
                if (isset($filters->order) && ! isset($params->order)) {
                ...
                foreach ($filters as $filterName => $filterValue) {
                    ...
                    if (! in_array($filterName, $this->replaceFilters)) {
                        ...
                        if (in_array($filterNameSnake, $modelFillable)) {
                            ...
                            if ($filterNameSnake == 'id') {
                                $filterValue = (object) ['where' => 'in', 'value' => (array) $filterValue];
                            }
                            //Set filter
                ...
                if (isset($filters->withTrashed) && $filters->withTrashed) {
                    $query->withTrashed();
                }
        ...
        //Response complete
            ...
            if (isset($params->take) && $params->take) {
